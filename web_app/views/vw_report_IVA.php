...
echo form_open(base_url().'gestion/genera/', array('id' => 'formIVA','name' => 'formIVA'));
    ...
    echo '<fieldset> 
            <div class="row">
              ...
              <section class="col col-2"><label class="toggle"><input type="checkbox" name="iva_venta" id="iva_venta" value="YES" checked="checked"><i></i>IVA Venta</label> 
                                 '.br().'<label class="toggle"><input type="checkbox" name="iva_costo" id="iva_costo" value="YES" checked="checked"><i></i>IVA Costo</label> </section>              
              <section class="col col-2">
                <a class=\'button\' href=\'javascript:submitReportExcelAX("'.base_url().'","IVA");\'><i class="fa fa-file-excel-o"></i> Generar</a>
              </section
             </div>         
           </fieldset>';
echo form_close();
