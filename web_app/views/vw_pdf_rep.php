   ...
   $html = $html .'<body marginwidth="0" marginheight="0">'
                    ...
                    .  '<div style="width: 100%;">
						  ...
						  <tr>
							...
							<td width="35%" class="center"> <img src="images/'.$p['factPDF']['logo'].'" width="'.$p['factPDF']['logoWidth'].' px" height="'.$p['factPDF']['logoHeight'].' px"> </td>
                          </tr>
                          </tbody>
                          </table>
						</div>'
					...
					.'					  
					  ...
					  <tbody> 
						  <tr><td width="70%" class="left" style="font-size: 7pt;">
							   <span style="font-size: 7pt; color:#A81F24">'.nbs().'NÚMERO DE SERIE DEL CERTIFICADO DEL SAT'.nbs().'</span>
