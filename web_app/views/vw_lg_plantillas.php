...
<?php
        ...
        foreach($documentos as $doc)
	{
            ...
            $celda = $borrarPlantilla.'<a title="Material SILTEX" href="'.base_url().$doc['link'].'"> 
			<img title="Material SILTEX" src="'.base_url().'images/fileIcon.png">'.nbs(1).$doc['nombre'].'</a>'.br(2);
