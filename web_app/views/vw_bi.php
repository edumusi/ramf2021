...
{   
    ...
    echo '   </div>
            <!--/ tabs -->';    
    echo "<div id='homeChart' class='row'><section class='col col-3'>&nbsp;</section><section class='col col-4'><center>";	
    echo br(2);
    echo img(array('src'=> 'images/laptopWeb.jpg'), TRUE);     
    echo br(2);
    echo "/<center></section><section class='col col-3'>&nbsp;</section></div>";    
    echo '</div>';
