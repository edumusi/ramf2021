   ...
   $html = $html .'<body marginwidth="0" marginheight="0">'
                    ...
                    .  '<div style="width: 100%;">
						  ...
						  <tr>
							...
							<td width="33% class="left" style="font-size: 9pt;"> 
							...
							<td width="35%" class="center"> <img src="images/'.$f['factPDF']['logo'].'" width="'.$f['factPDF']['logoWidth'].' px" height="'.$f['factPDF']['logoHeight'].' px"> </td>
                          </tr>                          
                          </tbody>
                          </table>
						</div>'
					...
					.'	<table cellspacing="0" align="center" cellpadding="0" style="width: 100%;">
						...
						.'	<table cellspacing="0" align="center" cellpadding="0" style="width: 100%;">
								<tbody>								
									<tr> <td width="100%" colspan="5" class="center fondoColor" style="font-size: 8pt;"><strong>CFDI RELACIONADOS </strong> </td> </tr>
					...
					.'<table cellspacing="0" align="center" cellpadding="0" width="100%">
							<tbody> 
								<tr><td width="70%" class="left" style="font-size: 7pt;">
									 <span style="font-size: 7pt; color:#A81F24">'.nbs().'NÚMERO DE SERIE DEL CERTIFICADO DEL SAT'.nbs().'</span>'.nbs(6).'<span style="font-size: 7pt; color:#A81F24">'.nbs().'NÚMERO DE SERIE DEL CSD DEL EMISOR'.nbs().'</span>
							'.br(1).'<span style="font-size: 7pt; ">'.$r['representacion_impresa_certificadoSAT'].'</span>'.nbs(60).'<span style="font-size: 7pt; ">'.$r['representacion_impresa_certificado_no'].'</span>
									 '.br(2).'
									 <span style="font-size: 7pt; color:#A81F24">'.nbs().'SELLO DIGITAL DEL SAT'.nbs().'</span>
									 ';
							...
							$html = $html.br(2).'<span style="font-size: 7pt; color:#A81F24">'.nbs().'SELLO DIGITAL DEL CFDI'.nbs().'</span>';
							...
							$html = $html.br(2).'<span style="font-size: 7pt; color:#A81F24">'.nbs().'CADENA ORIGINAL DEL COMPLEMENTO DE CERTIFICACIÓN DIGITAL DEL SAT'.nbs().'</span>';
							...
							$html = $html.'
									...
									<td width="30%"><center><img src="'.$r['archivo_png'].'" width="170" height="170"> </center></td> 
								</tr>								
							</tbody> 
						</table>						
					'
					...
					.'  <div class="footer">
                          <table align="center" style="width: 100%;">
							...
							<tr>
								...
								<td width="25%" class="center" style="font-size: 6pt;"> CFDI emitido desde Sistemas Digitales Convivere </td>
