...
<?php
                ...
                <div class="row">          
                  <section class="col col-4">
                    ...
                    form_input(array('class'     => 'validate[required,custom[email]] text-input', 
                                     'name'        => 'correo', 
                                     'id'          => 'correo',
                                     'placeholder' => "Ej. e@siltex.com.mx",
                                     'value'       => $usr[0]['correo'],                                     
                                     'maxlength'   => '100')).'
	...
	echo   "</section>
                <section class='col col-4'>
                <div id='Firma'><img title='Firma Digitalizada' width='142' height='172' src='".base_url().$dirFoto.$firma."'></a><br><img class='boton_confirm' title='Borrar Firma' name='".$usr[0]['firma']."'  id='".$usr[0]['firma']."' src='".base_url()."/images/close.png'></div>
                </section>
                </div>";
         echo '<div class="row">          
                <section class="col col-4">
