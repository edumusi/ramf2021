			...
			for ($x = 0; $x <= $numconceptos; $x++) 
			{
				...
				if ($concep != "")
					{$rowsConcepto = $rowsConcepto."<tr><td width='4%'></td>".
						"   <td width='48%' align='left'> <img src='images/check.jpg'> ".$concep."</td>".
			...
			for ($x = 0; $x <= $numterminos; $x++) 
			{
				...
				if ($termino != "")
						{ $rowsTermino = $rowsTermino." <tr><td width='4%'></td>".
													  "     <td width='48%' align='left'> <img src='images/check.jpg'> ".$termino."</td>".
			...
			if ($numnotas != "" & $numcargos != "" & $numconceptos != "" & $numterminos != "")
			{
				if( $rowsTermino != "" && $rowsConcepto != "" )
				 { $myTable = $myTable."
					...
					"<tr>".
						"<td width='20%' align='center' style='background-color:#131F37; color: white;'>FLETE ".$valor.":</td>".
					...
					<tr>".
						"<td width='20%' align='center' style='background-color:#131F37; color: white;'>DETALLE DEL EMBARQUE:</td>".
						"<td width='80%' align='center' style='font-weight:bold;'> 
							<table cellspacing='0' width='100%' align='center' cellpadding='0' >								
								".$rowsConcepto."
							</table>
...
public function nuevo()
{
 try{
	...
	$data['tipos_servicio']     = $this -> md_catalogo  -> poblarServicios("tipo_servicio","TS");
	...
	$data['coti_pdf'] 	    = '';
	$data['atentamente']    = array( array("firma"=>NULL,"nombre"=>NULL,"apellidos"=>NULL,"telefono"=>NULL,"celular"=>NULL,"correo"=>NULL, "titulo"=>NULL));
...
private function traeDetalleCoti($id_coti, $tipos_servicio)
{
 try{	
	...
	$coti = $coti ==false ? array(array("fecha_alta"=>NULL, "prosp_nombre"=>NULL, "prosp_empresa"=>NULL, "asunto"=>NULL, "moneda"=>NULL, "tipo_cambio"=>NULL, "prosp_correo"=>NULL, "prosp_tel"=>NULL, "atentamente"=>NULL, "slAtte"=>NULL)) : $coti;
    $servicios = array();		
	//while (list($llave, $valor) = each($tipos_servicio)) 
	foreach($tipos_servicio as $llave => $valor)
    {   
