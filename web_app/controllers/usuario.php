         ...
         try{
            ...
            $param = array("titulo"          => "Cat&aacute;logo de Usuarios ".$msj,
                           "titulos"         => array("navegador" => TITULO_NAVEGADOR, 
                                          "           ventana"   => TITULO_VENTANA,
                                                    "frase"     => "\"Hacer de lo simple algo complicado es com&uacute;n; hacer de lo complicado algo simple, incre&iacute;blemente simple, es creatividad\" <br>- Charles Mingus",
                                                    "titulo"    => "Cat&aacute;logo de Usuarios ".$msj),
    ...
    public function bajaUserAX()
      ...
      public function agregaFirmaAX()
        ...
        try{	                
            ...
            $this -> md_usuario-> update_user($cuenta.CORREO_DOMINIO, array('firma'=>$idImagen.".".$extension) );
        ...
        try{	
            ...
            $this -> md_usuario-> update_user($cuenta.CORREO_DOMINIO, array('firma'=>'null.png') );    
