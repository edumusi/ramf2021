...
{	
	...
	$data['tipos_servicio'] = $this -> md_catalogo -> poblarSelect("tipo_servicio");
        $data['proveedor'] 	=  array('datos' => array(array('rfc'=>NULL, 'nombre'=>NULL, 'correo'=>NULL, 'calle'=>NULL, 'numero'=>NULL, 'colonia'=>NULL, 'delegacion'=>NULL, 'estado'=>NULL, 'pais'=>NULL, 'cp'=>NULL, 'tipo_servicio'=>NULL, 'id_prove'=>NULL, 'id_tipo_servicio'=>NULL, 'tipo_servicio'=>NULL, 'obs'=>NULL)), 'contactos' => array() );
...
public function index()
	...
	$param = array("titulo"          => "Cat&aacute;logo de Proveedores ",
                       "titulos"         => array("navegador" => TITULO_NAVEGADOR, 
                                                  "ventana"   => TITULO_VENTANA,
                                                    "frase"     => "\"Hacer de lo simple algo complicado es com&uacute;n; hacer de lo complicado algo simple, incre&iacute;blemente simple, es creatividad\" <br>- Charles Mingus",
                                                    "titulo"    => "Cat&aacute;logo de Proveedores "),
