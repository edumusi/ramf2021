...
class Md_sat extends CI_Model {
    ...
    {
        $this->db->select('LTRIM(sat_TipoDeComprobante) as sat_TipoDeComprobante, Descripcion');        
        $this->db->like('LTRIM(sat_TipoDeComprobante)',  $tipo);
        $query = $this->db->get('sat_tipodecomprobante');
    ...
    {                   
        ...
        $this->db->select("('') as folio,p.moneda, p.id_pedido, p.rfc, cl.razon_social as nombre, p.venta_tot as importe_imp, p.venta_tot as total");
