...
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/Category.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/Database.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/DateTime.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/Engineering.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/Financial.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/Logical.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/LookupRef.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/MathTrig.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/Statistical.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/Calculation/TextData.php';

require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/CalcEngine/CyclicReferenceStack.php';
require_once APPPATH.'third_party/PhpOffice/PhpSpreadsheet/CalcEngine/Logger.php';
...
class Calculation
{
    ...
    private static $phpSpreadsheetFunctions = [
        ...
        'ACCRINT' => [
            ...
            'functionCall' => Category::CATEGORY_FINANCIAL,
            'argumentCount' => '4-7',
        ],
