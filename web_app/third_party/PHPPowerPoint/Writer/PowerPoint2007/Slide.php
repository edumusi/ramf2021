...
require_once APPPATH.'/third_party/PHPPowerPoint/Writer/PowerPoint2007.php';
...
/** PHPPowerPoint_Shape */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape.php';

/** PHPPowerPoint_Shape_RichText */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/RichText.php';

/** PHPPowerPoint_Shape_BaseDrawing */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/BaseDrawing.php';

/** PHPPowerPoint_Shape_Drawing */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/Drawing.php';

/** PHPPowerPoint_Shape_MemoryDrawing */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/MemoryDrawing.php';

/** PHPPowerPoint_Shared_Font */
require_once APPPATH.'/third_party/PHPPowerPoint/Shared/Font.php';

/** PHPPowerPoint_Shared_String */
require_once APPPATH.'/third_party/PHPPowerPoint/Shared/String.php';
