...
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/RichText/ITextElement.php';

/** PHPPowerPoint_Shape_RichText_TextElement */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/RichText/TextElement.php';

/** PHPPowerPoint_Shape_RichText_Run */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/RichText/Run.php';

/** PHPPowerPoint_Shape_RichText_Break */
require_once APPPATH.'/third_party/PHPPowerPoint/Shape/RichText/Break.php';

/** PHPPowerPoint_Style_Alignment */
require_once APPPATH.'/third_party/PHPPowerPoint/Style/Alignment.php';
