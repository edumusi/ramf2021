...
{	
    jAlert("Favor de seleccionar un tipo de sevicio",titAlert);
...
else
{
	...
	case 64:
		...
		rowsConcepto = 	" <tr><td width='10%'></td>"+
				 ...
				 */;
                rowCargoTotal 	 = "<tr>"+
				  "   <td width='45%' align='center'><label class='input'>Total</label></td>"+
				  "   <td width='30%' align='center'><section class='col col-8'><label class='input' id='totalServicioventas"+ts+"'></label></section></td>"+
		...
		rowsNota   = " <tr><td width='10%'></td>"+
				  ...
				  "		value='Toda mercancía que no sea notificada a RAMF LOGISTICS S.A de C.V, es responsabilidad del cliente, lo anterior engloba todo problema o sanción (fiscal, aduanal o de cualquier índole) impuesta por cualquier autoridad previamente, durante y posteriormente al despacho aduanal.' "+
	...
	break;
		...
		titulo 	     = "IMPORTACIÓN";
		rowsConcepto = 	" <tr><td width='10%'></td>"+
				  " <td width='40%' align='center'><label class='input'><i class='icon-append fa fa-bookmark'></i><input type='text' name='"+ts+"concep0' value='TIPO DE MERCANCIA' class='validate[required,custom[onlyLetterNumber]] text-input' id='"+ts+"concep0' size='25'  maxlength='100'/></label></td>"+
				  ...
				  " <td width='10%'><img title='Eliminar Concepto' class='"+ts+"btnDeleteConcepto' src='"+baseURL+"images/erase.png'></td></tr>"+
                                  " <tr><td width='10%'></td>"+
				  " <td width='40%' align='center'><label class='input'><i class='icon-append fa fa-bookmark'></i><input type='text' name='"+ts+"concep4' value='VALOR DE LA MERCANCIA' class='validate[required,custom[onlyLetterNumber]] text-input' id='"+ts+"concep4' size='25'  maxlength='100'/></label></td>"+
				  " <td width='40%' align='center'><label class='input'><i class='icon-append fa fa-text-width'></i><input type='text' name='"+ts+"concep_dato4' value='' placeholder='1000' class='validate[required,custom[onlyLetterNumber]] text-input' id='"+ts+"concep_dato4' size='25'  maxlength='100'/></label></td>"+
				  " <td width='10%'><img title='Eliminar Concepto' class='"+ts+"btnDeleteConcepto' src='"+baseURL+"images/erase.png'></td></tr>";
		rowsCargo 	 = " <tr>"+
				  "   <td width='45%' align='center'><label class='input'><i class='icon-append fa fa-bookmark'></i><input type='text' name='"+ts+"cargo0' value='FLETE INTERNACIONAL ' class='validate[required,custom[onlyLetterNumber]] text-input' id='"+ts+"cargo0' size='25'  maxlength='100'/></label></td>"+
				  "   <td width='30%' align='center'><section class='col col-8'><label class='input'><i class='icon-append fa fa-usd'></i><input type='text' name='"+ts+"importe0' value='1' class='validate[required,custom[number]] text-input ventas"+ts+"' id='"+ts+"importe0' size='8'  maxlength='10'/></label></section></td>"+
	...
	break;
		...
		rowsConcepto = 	" <tr><td width='10%'></td>"+
				  ...
				  " <td width='10%'><img title='Eliminar Concepto' class='"+ts+"btnDeleteConcepto' src='"+baseURL+"images/erase.png'></td></tr>";
		rowsCargo 	 = " <tr>"+
				  "   <td width='45%' align='center'><label class='input'><i class='icon-append fa fa-bookmark'></i><input type='text' name='"+ts+"cargo0' value='HONORARIOS AGENTE ADUANAL ' class='validate[required,custom[onlyLetterNumber]] text-input' id='"+ts+"cargo0' size='25'  maxlength='100'/></label></td>"+
				  "   <td width='30%' align='center'><section class='col col-8'><label class='input'><i class='icon-append fa fa-usd'></i><input type='text' name='"+ts+"importe0' value='' class='validate[required,custom[number]] text-input ventas"+ts+"' id='"+ts+"importe0' size='8'  maxlength='10'/></label></section></td>"+
				  "   <td width='23%'  align='center'><input type='checkbox' name='"+ts+"iva0' id='"+ts+"iva0' value='1' />más iva</td>"+
                                  "   <td width='7%'  align='center'><img title='Eliminar Concepto' class='"+ts+"btnDeleteCargo' src='"+baseURL+"images/erase.png'></td></tr>"+
				  " <tr>"+
				  "   <td width='45%' align='center'><label class='input'><i class='icon-append fa fa-bookmark'></i><input type='text' name='"+ts+"cargo1' value='ESTIAMDO IMPUESTOS' class='validate[required,custom[onlyLetterNumber]] text-input' id='"+ts+"cargo1' size='25' maxlength='100'/></label></td>"+
				  "   <td width='30%' align='center'><section class='col col-8'><label class='input'><i class='icon-append fa fa-usd'></i><input type='text' name='"+ts+"importe1' value='' class='validate[required,custom[number]] text-input ventas"+ts+"' id='"+ts+"importe1' size='8'  maxlength='10'/></label></section></td>"+
                                  "   <td width='23%'  align='center'><input type='checkbox' name='"+ts+"iva1' id='"+ts+"iva1' value='1' />más iva</td>"+
				  "   <td width='7%'  align='center'><img title='Eliminar Concepto' class='"+ts+"btnDeleteCargo' src='"+baseURL+"images/erase.png'></td></tr>"+
				  " <tr>"+
				  "   <td width='45%' align='center'><label class='input'><i class='icon-append fa fa-bookmark'></i><input type='text' name='"+ts+"cargo2' value='ESTIMADO MANIOBRAS' class='validate[required,custom[onlyLetterNumber]] text-input' id='"+ts+"cargo2' size='25'  maxlength='100'/></label></td>"+
				  "   <td width='30%' align='center'><section class='col col-8'><label class='input'><i class='icon-append fa fa-usd'></i><input type='text' name='"+ts+"importe2' value='' class='validate[required,custom[number]] text-input ventas"+ts+"' id='"+ts+"importe2' size='8'  maxlength='10'/></label></section></td>"+
                                  "   <td width='23%'  align='center'><input type='checkbox' name='"+ts+"iva2' id='"+ts+"iva2' value='1' />más iva</td>"+
				  "   <td width='7%'  align='center'><img title='Eliminar Concepto' class='"+ts+"btnDeleteCargo' src='"+baseURL+"images/erase.png'></td></tr>";				 
                rowCargoTotal 	 = "<tr>"+
				  "   <td width='45%' align='center'><label class='input'>Total</label></td>"+
	...
	myTable = "<p></p>"+
			  ...
			  "<table id='terminos"+ts+"' cellspacing='0' align='center' cellpadding='0' width='100%'>"+
 			  "<tr><td width='100%' colspan='4' align='center' style='font-weight:bold; background-color:"+fondoFlete+"; color:#FFFFFF'>"+titulo+"</td></tr>"+
			  "<tr><td width='10%'></td><td width='80%' colspan='2' align='center' style='font-weight:bold; background-color:"+fondoFlete+"; color:#FFFFFF'>TERMINOS</td>"+
			  ...
			  "<tr ><td width='10%'></td><td width='80%' colspan='2' align='center' style='font-weight:bold; background-color:"+fondoFlete+"; color:#FFFFFF'>DETALLE DEL EMBARQUE</td>"+
			  "<td width='10%' align='center'> "+
			  ...
			  " <tr>"+
			  " <td width='45%' align='center' style='font-weight:bold; background-color:"+fondoFlete+"; color:#FFFFFF'>CONCEPTO</td>"+
			  " <td width='45%' align='center' style='font-weight:bold; background-color:"+fondoFlete+"; color:#FFFFFF'>IMPORTE EN <span id='monedaSpan'>"+moneda+"</span></td>"+
                          " <td width='3%'></td>"+
			  ...
			  " <tr><td width='10%'></td>"+
			  " <td width='80%' align='center' style='font-weight:bold; background-color:"+fondoFlete+"; color:#FFFFFF' colspan='2'>NOTAS</td>"+
			  " <td width='10%' align='center'>"+
...
$.ajax({
        ...
        dataType  : 'json',
        beforeSend: function () 
                   { $("#cotiMensaje").html("<img src=\""+baseURL+"images/loading.gif\"> Cargando Datos, espere por favor..."); },
        success   : function (response) 
                    {$("#cotiMensaje").html("");
            ...
            switch (boton)
             {
				...
				case 'btnDeleteCargo'   : leyenda = " Venta del servicio";    break;
	...
	$("."+ts+"nuevoCargo").click(function()
		{
		 ...
		 var myRow = " <tr>"+
			...
			"   <td width='3%'  align='center'><input type='checkbox' name='"+ts+"ivaV"+nc+"' id='"+ts+"ivaV"+nc+"' value='1' class='checBokFact' /> más iva</td>"+
...
function generaCotiPDFAX(baseURL)		
{
    ...
    dataType  : 'json',
    beforeSend: function () 
        { $("#generaCotiPDF").html("<img src=\""+baseURL+"images/loading.gif\" width='80px' heig='50px'> Generando Archivo, espere por favor...");},
    success:  function (response) 
                    {
...
function validaCampoDuplicadoAX(tipo,campo,valor,baseURL){
		...
		dataType  : 'json',
                beforeSend: function () 
				{ $("#valida"+campo).html("<img src=\""+baseURL+"images/loading.gif\"> Validando "+campo+", espere por favor..."); },
                success:  function (response) 
				{
 				 $("#valida"+campo).html("");
...
function validaCorreoAsignadoAX(correo,baseURL){
        ...
        $.ajax({
				...
				dataType  : 'json',
                beforeSend: function () 
				{ $("#validaCorreo").html("<img src=\""+baseURL+"images/loading.gif\"> Validando Correo, espere por favor..."); },
                success:  function (response) 
				{					
				 var cliente = "<table width=\"100%\" border=\"0\" cellspacing=\"0\" align=\"left\" "
							  ...
							  +"<br>Delegacion "+String(response['delegacion'])
							  +"<br>"+String(response['estado'])+' '+String(response['pais'])+"</td>"
							  +"<td>"+"<a href=\""+baseURL+"gestion/dc/"+response['rfc']+"\">"
							  +"<img title=\"Detalle Cliente\" src=\""+baseURL+"images/detail.png\"></a>"		
							  +"&nbsp;&nbsp;&nbsp;"
							  +"<a href=\""+baseURL+"gestion/editarCliente/"+response['rfc']+"\">"
		...
		dataType: 'json',                
				...
				{		
					var	iconP="<img class='boton_confirm' title='Borrar Plantilla' id='"+response['nombreSenni']+"' src='"+baseURL+"/images/close.png'> &nbsp;&nbsp;&nbsp;&nbsp;"+
                                                      " <a title='Material "+$("#companyName").val()+"' href='"+baseURL+response['link']+"'> "+
                                                      " <img title='Material "+$("#companyName").val()+"' src='"+baseURL+"images/fileIcon.png'>  "+response['nombreSenni']+"</a><br><br>";
...
{    	
    ...
    var param = {"nombreArchivo" : nombreArchivoStr.substring(0, len_ext-1),
		 "extension"	 : extensionStr.substring(len_ext,len),
                 "cuenta"        : cuenta.replace(String($("#correoDominio").val()),'')   };             
    $.ajax({ 
            data    : param,               
...
function recuperarPwdAX(baseURL,forma)
{
  ...
  if($("#"+forma).validationEngine('validate'))
  {
    ...
    $.ajax({ 
            ...
            type      : 'post',
            dataType  : 'json',
            beforeSend: function () {$("#leyendaPWD").html("<br><img src=\""+baseURL+"images/loading.gif\"> Validando Cuenta, espere por favor...");},
            success   :  function (response) 
                        {
                            $("#leyendaPWD").html("");						
                            if(response['existe']=== true)
                            {
                                $("#leyendaPWD").attr( "style", "color:#15BC57;" );
                                $("#leyendaPWD").html("<img src=\""+baseURL+"images/check.png\"> La contaseña ha sido enviada a la cuenta de correo: "+correo);
                                $("#usuario").val(correo);
                            }
                            else
                               {   $("#leyendaPWD").attr( "style", "color:red;" );
                                   $("#leyendaPWD").html("<img src=\""+baseURL+"images/close.png\"> No se encuentra registrada la cuenta de correo: "+correo);
                               }
                        }, 
...
{    	
		...
		data	  : param,               
				...
				{	
                                    ...
                                    {
                                        $("#mensajeContacto").attr( "style", "color:red;" );
                                        $("#mensajeContacto").html("<img src=\""+baseURL+"images/close.png\"> El código captcha generado no coincide con el código captcha escrito, favor de verificar e intentar de nuevo");
                                    }
                                    else
                                    {
...
function traeProveedoresPorTSAX(ts,baseURL)
{
	...
	$.ajax({ 
			...
			dataType   : 'json',
			 beforeSend: function () 
			{
			   $("#tsMensaje").html("<img src=\""+baseURL+"images/loading.gif\"> Trayendo proveedores por tipo de servicio, espere por favor...");
			},
			success:  function (response) 
			{																	
				$("#tsMensaje").html("");
                   ...
                   case  'gestion':
                    ...
                    case 'pedido':                    
                        ...
                        for( var i=0; i<registros[x]['adjuntos'].length; i++ )
						   { adjuntos = adjuntos + '<a href="'+baseURL+registros[x]['adjuntos'][i]['adjunto']+'" target="_blank"><img title="'+registros[x]['adjuntos'][i]['desc_adjunto']+'" src="'+baseURL+'images/fileIcon.png"></a>&nbsp;'; }
                        ...
                        columna = columna + '<td align="center">'+adjuntos+'</td>'; 
    ...
    $.ajax({ url      : baseURL+'gestion/paginarFacturasAX/',
             ...
             {				   			   
               ...
               {   
				   ...
				   {
						$('#grid > thead').html("<tr><th align='center'>#</th><th align='center'>Referencia Ramf</th><th align='center'>Folio</th><th align='center'>RFC</th><th align='center'>Razon Social</th><th align='center'>Total</th><th align='center'>Moneda</th><th align='center'>Fecha</th><th align='center'>Acciones</th></tr>"); 
...
{    	
    ...
    $.ajax({ url      : baseURL+'gestion/paginarRNominasAX/',
             ...
             error: function(err) { alert("Ha ocurrido un error al paginarRNominasAX: " + err.status + " " + err.statusText); }
             });
}
             ...
             { $("#spinPaginarMisRecibos").html("");
               ...
               {   var id    = response['offset'];                    
                   ...
                   {    id = id + 1;					
						...
						var iconF = "<a href='"+baseURL+registros[x]['dir_cfdi']+registros[x]['filename']+"' target='_blank'> <img src=\""+baseURL+"images/zip.jpg\" width='24px' heigth='21px'> "+registros[x]['filename']+" </a>"; 
    ...
    $.ajax({data      :  paramReport,
            ...
            success   : function (resp) 
						...
						$('#tblRepFact').html( '<tr>'
												...
												+'<td width="10% " style="text-align:center"><small><strong>Moneda</strong></small></td>'
						...
						$.each( resp["adjuntoFac"], function(i, value) 
								{ $('#tblRepFact').append( "<tr> <td> <input type='radio' class='selFac' id='f"+value['id_factura']+"' name='facturaPedido' value='"+value['id_factura']+"'></td>"
																+"<td align='left'><a href='"+$("#baseURL").val()+value["adjunto"]+"' target='_blank'><small>"+value['filename']+"</small></a></td>"
						...
						$.each( resp['facturaREP'], function(i, value) 
								{   var dirPath = value["adjunto"];
									...
									var TRiconF = "<tr><td width='15%'> <a href='"+$("#baseURL").val()+value["adjunto"]+"' target='_blank'><small>"+value['filename']+"</small></a> </td>"+
									...
									"  <td width='25%'> <a href='"+$("#baseURL").val()+dirPath+value["path_pdf"]+"' target='_blank'>"+
						...
						$( "#uuidCfdiRel" ).autocomplete({
							source: function( request, response ) {
							$.ajax( { url     : baseURL+'pedido/uuidCfdiRel_AX',
									  type    : 'post',
									  dataType: "json",
									  data    : { search: request.term },
									  success : function( data ) { response( data ); }
	...
	$.ajax({data	  : param,
			...
			{	var cfdiRelTot= Number($("#cfdiRelTot").val()) + 1;
				...
				var	TRcfdirel = "<tr>  <td style='text-align:right' ><input type='checkbox' class='selCfdiRel' id='CfdiRel"+cfdiRelTot+"' name='CfdiRelSel"+cfdiRelTot+"' value='"+resp['uuid']+"' checked> </td>"+
									  ...
									  "<td style='text-align:left'  ><small><a href='"+resp["adjunto"]+"' target='_blank'> <img title='Factura' src='"+$("#baseURL").val()+"images/logoPDF.png' width='18px' height='18px'> <small>PDF</small> </a></small> </td>"+
...
{ //alert("VISTA PREVIA EN CONTRUCCIÓN: "+$('#CFDI_FORM').serialize());
...
{ 		
	...
	{       
		$.ajax({url       :  $("#baseURL").val()+'pedido/timbrarAX/'+$("#id_pedido").val()+'/timbrar',
				type      : 'post',
				dataType  : 'json',
				...
				success   : function (resp) 
					{ $("#confirmtimbrar").html("");						
						...
						{ 
						var	iconF = "<a style='color:#76a035' href='"+$("#baseURL").val()+resp["success"]["pdf"]+"' target='_blank'>"
								  ...
								  + "</a>&nbsp&nbsp&nbsp"
								  + "<a style='color:#76a035' href='"+$("#baseURL").val()+resp["success"]["xml"]+"' target='_blank'>"
...
{ 		
	...
	{       
		$.ajax({url       :  $("#baseURL").val()+'pedido/timbrarCfdiRelAX/'+$("#id_pedido").val()+'/timbrarcfdirel',
				type      : 'post',
				dataType  : 'json',
				data	  : $('#CFDI_FORM').serialize(),
				beforeSend: function () {  $("#confirmtimbrar").html(""); $("#confirmtimbrar").html("<img src=\""+$("#baseURL").val()+"images/loading.gif\" width='50px' height='50px'> Cargando información. Espere por favor...");},
	...
	$.ajax({data      : { idFactura: idFactura },
			...
			success   : function (resp) 
					{   $("#confirmtimbrar").html("");
						...
						{ $('#lblStat'+resp["success"]['id_factura']).html(resp["success"]['status']); }
...
{ 		
	...
	{       
		$.ajax({url       : $("#baseURL").val()+'gestion/timbrarRecNomAX/timb',
				type      : 'post',
				dataType  : 'json',
				...
				success   : function (resp) 
					{ $("#confirmtimbrar").html("");						
						...
						{ 
						var	iconF = "<a style='color:#76a035' href='"+$("#baseURL").val()+resp["success"]["pdf"]+"' target='_blank'>"
									+ "<img src='"+$("#baseURL").val()+"images/check.png'> <img title='FACTURA' src='"+$("#baseURL").val()+"images/logoPDF.png' width='25px' height='25px'> Recibo de Nomina</a>";						
						$("#timbrarPDF").html(iconF);
...
{ 		
	...
	{       
		$.ajax({url       :  $("#baseURL").val()+'pedido/timbrarAX/'+$("#id_pedido").val()+'/timbrar_rep',
				type      : 'post',
				dataType  : 'json',
				data	  : $('#CFDI_FORM').serialize(),
					...
					{ $("#confirmtimbrar_rep").html("");						
						...
						{ 
							...
							var	TRiconF = "<tr> <td width='15%'> "+factura+" </td>"+
											...
											"   <td width='25% '> <a href='"+$("#baseURL").val()+resp['success']['pdf']+"' target='_blank'>"+
											"					  <img title='REP' src='"+$("#baseURL").val()+"images/logoPDF.png' width='18px' height='18px'> <small>REP </small> </a></td>"+
											"	</tr>";
