...
$(document).ready(function() {
	...
	initLightbox();
	// modal popup init
	function initLightbox() { "use strict";
                                  jQuery('a.lightbox, a[rel*="lightbox"]').fancybox({ padding: 0 });
                                  jQuery("#newsletterII-hiddenlink"        ).fancybox().trigger('click');
                                }
	...
	function initCounter() {
        ...
        $(".modalRastreo").colorbox({ inline       :true, width :"85%", height :"85%"
                                ,onOpen     :function(){ submitFormRastreoAX( $("#baseURL").val() );
                                                       }
                                ,onComplete :function(){ 
                                                       }
